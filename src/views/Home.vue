<template>
  <div>
    ...
    <v-card color="mb-8">
      ...
      >
        <v-card-title class="text-center justify-center pt-7 pb-12">
          <h1 class="font-weight-black headline">わくわくフェスティバルは<br>子供から大人まで愛犬と一緒に楽しめるイベントです！</h1>
        </v-card-title>
        <v-container fluid>
        <v-tabs
          v-model="tab"
        ...
        <v-tabs-items id="tab" v-model="tab">
          <v-tab-item>
            <v-card>
              <v-card-text>
                <ul class="pa-0 subtitle-1 text-center">
                  ...
                  <li>愛知県国際展示場<br>愛知県常滑市セントレア5丁目10番地1号</li>              
                </ul>
              </v-card-text>
            </v-card>
          </v-tab-item>
          <v-tab-item>
            <v-card>
              <v-card-text>
                ...
                <li class="py-3 font-weight-bold">前売り券<br>（コンビニ各店にて販売中）</li>
                <li>大人:1,300円</li>
                <li>子供（小学生以下）:700円</li>
                <li>学生:1,000円</li>
                ...
                <li>大人:1,600円</li>
                <li>子供（小学生以下）:900円</li>
                <li class="mb-3">学生:1,300円</li>
                <li>※学生の方は、ご入場の際に学生証の提示をお願いする場合があります。</li>
                <li>※入場料 2歳以下無料</li>
                </ul>
              </v-card-text>
            </v-card>
    ...
    <v-container>
      <v-row>
        <v-col
          v-for="bannar in bannars"
          :key="bannar.id"
          cols="12"
          md="12"
        >
          <v-item v-slot:default="{ active, toggle }" class="mb-12">
            <v-card
  ...
  data() {
    return {
      ...
      bannars: [
        ...
        {id: 3,name: '子供の楽園',to: '/park',color: '#5C6BC0'},
      ]
    }
  },
}
